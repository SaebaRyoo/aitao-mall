...
public class DateUtil {
    ...
    public static final String PATTERN_YYYY_MM_DD__HH___MM = "yyyy-MM-dd HH:mm";
     ...
     * @return
     */
    public static List<String> getDateMenus(String form){
        //定义一个List<Date>集合，存储所有时间段
        List<Date> dates = getDates(12);
        //判断当前时间属于哪个时间范围
        Date now = new Date();
        ...
        for (int i = 0; i <5 ; i++) {
            dateMenus.add(data2str(addDateHour(now,i*2), form));
        }
        return dateMenus;
    }
