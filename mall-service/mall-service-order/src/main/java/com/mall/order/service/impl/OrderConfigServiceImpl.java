...
import com.mall.order.dao.OrderConfigMapper;
import com.mall.order.pojo.OrderConfig;
import com.mall.order.service.OrderConfigService;
...
public class OrderConfigServiceImpl implements OrderConfigService {
    ...
    @Autowired
    public void setOrderConfigMapper(OrderConfigMapper orderConfigMapper) {
