...
import com.mall.order.dao.OrderLogMapper;
import com.mall.order.pojo.OrderLog;
import com.mall.order.service.OrderLogService;
...
public class OrderLogServiceImpl implements OrderLogService {
    ...
    public Example createExample(OrderLog orderLog){
        ...
        if(orderLog!=null){
            ...
            // 发货状态
            if(!StringUtils.isEmpty(orderLog.getShippingStatus())){
                    criteria.andEqualTo("shippingStatus",orderLog.getShippingStatus());
            }
            // 备注
