...
public class UserController {
    ...
    public Result addPoints(String username, Integer points){
    ...
    //@PostMapping("/login")
    //public Result<User> login(@RequestBody User usr, HttpServletResponse response, HttpServletRequest request) {
