...
public class Order implements Serializable{
	...
	@Column(name = "shipping_task_id")
	private String shippingTaskId; // 物流任务id -> 对接的第三方

	@Column(name = "shipping_status")
	private String shippingStatus;//发货状态,0:未发货，1：已发货，2：已收货
	...
	public String getShippingTaskId() {
		return shippingTaskId;
	}

	public void setShippingTaskId(String shippingTaskId) {
		this.shippingTaskId = shippingTaskId;
	}
